...
namespace _Game.Car
{
    public class CarController : MonoBehaviour
    {
        ...
        */
        ...
        void Update()
        {
            ///new method - added if condition in update() for enabling carcontrols
            ...
            localVelocityX = transform.InverseTransformDirection(_carRigidbody.linearVelocity).x;
            // Save the local velocity of the car in the z axis. Used to know if the car is going forward or backwards.
            localVelocityZ = transform.InverseTransformDirection(_carRigidbody.linearVelocity).z;
        ...
        public void DecelerateCar()
        {
            ...
            _carRigidbody.linearVelocity = _carRigidbody.linearVelocity * (1f / (1f + (0.025f * _carConfig.DecelerationMultiplier)));
        ...
        /// <summary>
        /// new method - enable/disable car controls
        /// </summary>
